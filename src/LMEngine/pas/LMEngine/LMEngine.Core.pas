  ...
  begin
    ...
    try
      if TFile.Exists('log.txt') then
        LLog.LoadFromFile('log.txt');
      LLog.Add(Format(AFormat, AArgs));
      LLog.SaveToFile('log.txt');
    finally
      LLog.Free;
    end;
  end;
...
begin
  ...
  try
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  // Add detailed logging before llama_decode
                  Log('Running llama_decode with LEval=%d, LPast=%d', [LEval, LPast]);
                  ...
                  begin
                    ...
                    Log('Vulkan backend error: LEval=%d, LPast=%d', [LEval, LPast]);
                    Break;
                  end;
    ...
    begin
      SetError(E.Message);
      Log('Exception during inference: %s', [E.Message]);
      Exit;
    end;
  end;
end;
